...
def get_3D_coordinates(filename, show_each_frame = False):
    ...
    colour_image_pixels_to_locate_list = [[i,0] for i in range(1920)]
    ...
    while depth_file_not_finished == True:
        try:
            ...
            # print(np.array(three_D_pixel_positions_in_frame).shape)  
...
if __name__ == '__main__': 
    ...
    three_dimensionsal_positions = get_3D_coordinates('test.23.3.3.51', show_each_frame =  True)
    print(np.array(three_dimensionsal_positions).shape)
